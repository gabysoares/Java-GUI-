...
public class AnimationPanel extends JComponent implements Runnable {
	...
	public AnimationPanel() {
		...
		s = new MovingRectangle(10, 10, currentWidth, currentHeight, marginWidth, marginHeight, currentBorderColor, currentPath);
		//
	...
	protected void createNewShape(int x, int y) {
		...
		switch (currentShapeType) {
			case 0: { //rectnage
				s =  new MovingRectangle(x, y, currentWidth, currentHeight, marginWidth, marginHeight, currentBorderColor,currentPath);
				break;
			}
		}
	}
